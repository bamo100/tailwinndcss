...
const Hero = () => {
 ...
 console.log(bigShoeImg)
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 z-30">
        <p className="text-xl font-montserrat text-[red]">Our Summer Collection</p>
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-slate-100 bg-cover bg-center">
